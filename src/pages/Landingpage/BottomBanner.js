...
const BottomBanner = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://digimoney-bank-0haz.onrender.com/visitordata", {
      method: "POST",
      headers: {
  ...
  return (
    <section
      data-aos="fade-in"
      className="bg-neutral lg:pt-28 pt-12 px-2 lg:px-0 lg:pb-36 pb-1 "
    >
      <div className="mx-auto border-[#0C444B] px-2  py-16 lg:px-16 lg:w-8/12 border-2">
        <div className=" grid lg:grid-cols-2 ">
          ...
          <div>
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="btn  bg-base-300 hover:bg-base-300  py-3 mt-5 ml-auto block h-auto text-[#F8BF88] border-none font-bold"
              >
                Get Started
              </button>
            </form>
        ...
        <p className="text-center font-semibold text-base-300 mt-8 lg:my-16">
