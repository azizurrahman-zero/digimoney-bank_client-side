        ...
        <div>
            ...
            <div className='mt-8'>
                ...
                <div className='flex items-center gap-x-4 mt-8'>
                   ...
                   <input className='input input-primary border-[#2366B5] rounded-none pr-32 focus:outline-none' type="text" value="Istiak " />
                </div>
                <div className='flex items-center gap-x-4 mt-8'>
                ...
                <div className='flex items-center gap-x-4 mt-8'>
                   ...
                   <input className='input input-primary border-[#2366B5] pr-32 rounded-none focus:outline-none' type="email" value="istiak.info@gmail.com" />
                </div>
            </div>
            <div className='mt-8'>
