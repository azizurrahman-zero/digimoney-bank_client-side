...
const Footer = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://digimoney-bank-0haz.onrender.com/subscribe", {
      method: "POST",
      headers: {
          ...
          <form action="" onSubmit={handleSubmit}>
            <div className="flex items-center my-4 gap-x-2 ">
              <input
                name="email"
                required
                className="input border-none focus:outline-none w-7/12 input-primary rounded-none"
                type="text"
              ...
              <button>
                <AiOutlineArrowRight
                  type="submit"
                  className="text-white bg-secondary  w-12 h-[100%] "
                />
              </button>
            </div>
          </form>
          <p className="text-gray-400">
            By submitting this form , you acknwledge that <br />
            you have the terms of our privacy statement
          </p>
        </div>
        <div>
